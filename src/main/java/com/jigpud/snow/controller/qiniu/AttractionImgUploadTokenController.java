...
@Slf4j
@RestController
public class AttractionImgUploadTokenController extends BaseController {
    private final QiniuService qiniuService;

    @Autowired
    AttractionImgUploadTokenController(QiniuService qiniuService) {
    ...
    ResponseBody<UploadTokenResponse> getAttractionImgUploadToken() {
        ...
        log.debug("attractionImgUploadToken -> uploadToken: {}, filename: {}", uploadToken, filename);
